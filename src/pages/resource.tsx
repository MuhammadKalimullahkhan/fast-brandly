...
const ResourceCard: React.FC<CardProps> = ({ icon, title, description }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white p-4 sm:p-6 rounded-xl shadow-lg transition-shadow duration-300 flex flex-col sm:flex-row items-center sm:items-start"
    >
      <motion.div
  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        className="hero__section min-h-screen flex flex-col justify-center items-center lg:items-start py-20 text-white text-center lg:text-left px-4 sm:px-8 lg:px-32 relative"
      >
        <div className="hero__section-overlay absolute inset-0 bg-black/50 z-0"></div>

        {/* Rotating Sphere - Hidden on mobile */}
        <motion.div
          className="hero__sphere absolute right-32 z-10 opacity-50 rounded-full shadow-blue-400 hidden lg:block"
          animate={{
            rotateY: 360,
            rotateX: 360,
          }}
        ...
        <motion.div
          ...
          className="relative z-10 w-full max-w-4xl mx-auto lg:mx-0"
        >
          <SectionHeading
            variant="secondary"
            size="lg"
      ...
      <motion.section
        ...
        className="py-12 sm:py-16 px-4 max-w-5xl mx-auto"
      >
        ...
        <motion.div
          ...
          transition={{ duration: 0.85 }}
          viewport={{ once: true }}
          className="mb-6 text-base sm:text-lg text-center"
        >
          <motion.div
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            transition={{ duration: 0.85 }}
            viewport={{ once: true }}
            className="text-base sm:text-lg text-center mb-12 sm:mb-16"
          >
          ...
          <motion.div
            ...
            transition={{ duration: 0.85 }}
            viewport={{ once: true }}
            className="mb-16 sm:mb-20 space-y-8"
          >
      ...
      >
        ...
        <motion.div
          ...
          transition={{ duration: 0.85, staggerChildren: 0.1 }}
          viewport={{ once: true }}
          className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 max-w-5xl mx-auto"
        >
          <motion.div
      ...
      <motion.section
        ...
        transition={{ duration: 0.85 }}
        viewport={{ once: true }}
        className="bg-gray-100 py-12 sm:py-16 px-4"
      >
      ...
      <motion.section
        ...
        transition={{ duration: 0.85 }}
        viewport={{ once: true }}
        className="bg-blue-700 text-white py-12 sm:py-16 px-4 text-center"
      >
